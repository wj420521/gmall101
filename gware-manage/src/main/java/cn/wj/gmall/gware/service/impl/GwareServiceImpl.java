package cn.wj.gmall.gware.service.impl;


import cn.wj.gmall.gware.bean.WareInfo;
import cn.wj.gmall.gware.bean.WareOrderTask;
import cn.wj.gmall.gware.bean.WareOrderTaskDetail;
import cn.wj.gmall.gware.bean.WareSku;
import cn.wj.gmall.gware.enums.TaskStatus;
import cn.wj.gmall.gware.mapper.WareInfoMapper;
import cn.wj.gmall.gware.mapper.WareOrderTaskDetailMapper;
import cn.wj.gmall.gware.mapper.WareOrderTaskMapper;
import cn.wj.gmall.gware.mapper.WareSkuMapper;
import cn.wj.gmall.gware.service.GwareService;
...
public class GwareServiceImpl implements GwareService {
    ...
    public void sendToOrder(WareOrderTask wareOrderTask) throws JMSException {
        Connection conn = activeMQUtil.getConnectionFactory().createConnection();
